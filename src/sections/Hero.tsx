        ...
        <div className="container bg-blue-500 rounded text-white pt-10 md:pt-17">
            <div className="lg:grid grid-cols-2">
                <div className="p-6 md:p-10">
                    <h1 className="text-3xl md:text-4xl lg:text-5xl text-white text-center md:text-left font-semibold leading-tight md:leading-tight lg:leading-tight">Book Appointment With Trusted Doctors</h1>
                ...
                <div className="flex justify-center">
                    <img src={assets.header_img} decoding="async" loading="eager" className="w-96" alt="Hero image" />
                </div>
            </div>
        </div>
    )
