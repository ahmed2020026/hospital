...
const NavBar = () => {
    ...
    return (
        <header className="fixed top-0 left-0 w-full h-18 z-20 flex items-center justify-between px-4 md:px-2 py-5 shadow-xl md:shadow bg-white">
            ...
            <div className="icons-links flex items-center gap-2">
                ...
                <ul
                    ref={MenuSubRef}
                    className={`absolute right-0 top-[110%] w-56 bg-white border border-gray-200 rounded-lg shadow-lg p-1 transition-all duration-300 ease-out origin-top ${op
                ...
                >
                    <li className="rounded-md overflow-hidden">
                        <Link
                            to="/profile"
                            className="flex items-center gap-3 w-full px-3 py-2 text-sm text-gray-600 hover:bg-gray-100 hover:text-gray-900 transition"
                        >
                    ...
                    <li className="rounded-md overflow-hidden">
                        <Link
                            to="/"
                            className="flex items-center gap-3 w-full text-left px-3 py-2 text-sm text-red-600 hover:bg-red-50 hover:text-red-700 transition"
                        >
