            ...
            <div className="container">
                <div className="md:grid grid-cols-3 gap-5">
                    <div className="text-center rounded-lg mb-5">
                        <img src={assets.contact_image} className="block mx-auto rounded-md" alt='About image' />
                    </div>
                    <div className="col-span-2 md:pr-15">
                        ...
                        <h4 className="mt-5 text-gray-700 mb-3 font-medium text-xl">CAREERS AT PRESCRIPTO</h4>
