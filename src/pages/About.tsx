            ...
            <div className="container">
                <div className="md:grid grid-cols-3 gap-5">
                    <div className="text-center rounded-lg mb-5">
                        <img loading="lazy" src={assets.about_image} className="block mx-auto rounded-md" alt='About image' />
                    </div>
                    <div className="col-span-2 md:pr-15">
                        ...
                        <h2 className="flex items-center gap-1 font-medium text-gray-700 mt-3">Our Vision</h2>
